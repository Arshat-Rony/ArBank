        ...
        <div style={{ marginTop: "100px", overflowX: "none" }}>
            ...
            <div className="row container-fluid mx-auto p-0">
                <div className="col-md-2 dashboard_link_section py-4 py-md-0">
                    <Link to="/dashboard/myprofile" className={`d-block py-3 rounded-3 py-md-2 dashboard_link text-center mt-4 text-decoration-none ${location.pathname === "/dashboard/myprofile" ? "bg-danger" : "bg-white text-dark"}`}>My Profile</Link>
                    <Link to="/dashboard/transactions" className={`d-block py-3 rounded-3 py-md-2 dashboard_link text-center mt-4 text-decoration-none ${location.pathname === "/dashboard/transactions" || location.pathname === "/dashboard" ? "bg-danger" : "bg-white text-dark"}`}>My Transactions</Link>
